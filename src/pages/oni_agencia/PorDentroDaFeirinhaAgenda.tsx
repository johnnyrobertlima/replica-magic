...
const clientId = "por-dentro-da-feirinha";

export default function PorDentroDaFeirinhaAgenda() {
  ...
  const [selectedCollaborator, setSelectedCollaborator] = useState(initialCollaborator || null);
  ...
  return (
    <div className="container relative pt-6">
      <ClientAreaHeader 
        title="Por Dentro da Feirinha" 
        description={`Acompanhe a agenda de conteúdo Por Dentro da Feirinha - ${formattedDate}`}
      />
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <Button onClick={() => navigate('/client-area/por-dentro-da-feirinha/controle-de-pauta/novo')}>
