...
/**
 * Fetches all pedidos directly in batches
 */
...
/**
 * Fetches detailed pedidos information for specific numbers
 */
...
/**
 * Fetches related data (pessoas, itens, estoque) for pedidos
 */
...
/**
 * Fetches items that are in separation
 */
...
/**
 * Fetches totals using RPC functions
 */
export async function fetchTotalsData(): Promise<{ valorTotalSaldo: number, valorFaturarComEstoque: number }> {
