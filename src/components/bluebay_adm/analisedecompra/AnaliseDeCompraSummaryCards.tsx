...
interface AnaliseDeCompraSummaryCardsProps {
  totalGroups: number;
  totalItems: number;
  totalPhysicalStock: number;
}

export const AnaliseDeCompraSummaryCards = ({ totalGroups, totalItems, totalPhysicalStock }: AnaliseDeCompraSummaryCardsProps) => {
  return (
