            ...
            <Table className="w-auto min-w-full border-collapse">
              <TableHeader className="sticky-header">
                <TableRow>
                  ...
                  <TableSortableHeader sortKey="CUSTO_MEDIO" label="Custo" currentSortConfig={sortConfig} onSort={onSort} width="150px" align="right" />
                  <TableSortableHeader sortKey="LUCRO" label="Lucro" currentSortConfig={sortConfig} onSort={onSort} width="150px" align="right" />
